"use client";
import { ArrowDownward, ArrowUpward, ElectricCarSharp, Euro, Star } from "@mui/icons-material";
...
const ratingOptions: RatingOption[] = [
  ...
  { value: "power_asc", label: "Power", icon: <ElectricCarSharp />, isAscending: true },
  { value: "power_desc", label: "Power", icon: <ElectricCarSharp /> },
];


export default function Sorting() {
  const sort = "rating_asc";
  ...
  return (
    <Box display="flex" gap={2} alignItems="center">
      ...
      <FormControl fullWidth>
        ...
        <Select labelId="sort" id="sort" value={sort} label="Sort by" displayEmpty>
